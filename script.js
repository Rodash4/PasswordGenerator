...
var keySets = {
 ...
 if (lowercase === "yes") {
  ...
    if (numberKeys === "yes") {
     var passwordIndex = getPassword(0, keySets.number.length -1);
     var keys = keySets.number[passwordIndex];
     password = password + keys;
     i++;
     if (i >= length )
      break;
  ...
    if (specialKeys === "yes") {
     var passwordIndex = getPassword(0, keySets.special.length -1);
     var keys = keySets.special[passwordIndex];
     password = password + keys;
     i++;
     if (i >= length )
       break;
